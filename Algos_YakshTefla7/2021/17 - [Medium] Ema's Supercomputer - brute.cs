...
//                    while (!succeed && val1 != -1 && val2 != -1 && ((1 + 4 * val1) * (1 + 4 * val2) > max))
//                    {
//                        int ii = 1 + 4 * val1;
//                        int jj = 1 + 4 * val2;
...
//                            for (int x = x1 - val1; x <= x1 + val1; x++)
//                            {
//                                //bool xx = (x == x2 && y1 <= y2 + values[j] && y1 >= y2 - values[j])
//                                //          || (y1 == y2 && x <= x2 + values[j] && x >= x2 - values[j]);

//                                if (pointIncluded(x, y1, x2, y2, val2))
//                                    intersect = true;
//                            }

//                            for (int y = y1 - val1; y <= y1 + val1; y++)
//                            {
//                                if (pointIncluded(x1, y, x2, y2, val2))
//                                    intersect = true;
//                            }
